...
If a future version adds an optional spam reporting feature, this privacy policy will be updated before release. Such a feature would only send report
data after a user action, and would explain what data is sent, why it is sent, and how it is used.
